  ...
  if (assign) {
    return `
      <div class="pos-cell assigned">
        ...
        <button class="btn-change" onclick="openRecordModal('${g.game_id}','${role}')">更換</button>
        <button class="btn-cancel" onclick="cancelRecordAssignment('${g.game_id}','${role}')">刪除</button>
      </div>
    `;
  }
